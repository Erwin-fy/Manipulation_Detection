...
class Model():
    ...
    def variable_with_weight_loss(self, shape, stddev, wl):
        ...
        if wl is not None:
            weight_loss = tf.mul(tf.nn.l2_loss(var), wl, name='weight_loss')
